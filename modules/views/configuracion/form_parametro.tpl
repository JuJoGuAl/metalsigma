            ...
            <div class="row">
              <div class="col-lg-6 col-sm-12">
                <div class="form-group">
                  <label for="parametro" class="control-label col-form-label">PARAMETRO</label>
                  <input type="text" class="form-control" id="parametro" name="parametro"value="{descripcion}" disabled>
                </div>
              </div>
              <div class="col-lg-6 col-sm-12">
                <div class="form-group">
                  <label for="valor" class="control-label col-form-label">VALOR</label>
                  <input type="text" class="form-control validar" id="valor" name="valor" value="{valor}" autocomplete="off"> 
                </div>
              </div>
            </div>
          </div>
