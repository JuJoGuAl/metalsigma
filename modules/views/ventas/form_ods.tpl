        ...
        <form role="form" name="form_" id="form_" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <div class="d-flex no-block align-items-center pb-3">
              <div>{form_title}<strong>COT-{id_tittle}</strong> - {form_title2}<strong>OS-ST{id_tittle2}</strong> - {form_title3}<strong>{id_tittle3}</strong></div>
                      ...
                      <table class="table table-bordered table-hover table-striped" id="table_resumen">
                        ...
                        <tfoot>
                          ...
                          <tr>
                            <td class="text-right">
                              DESC 
                              <input type="text" id="desc" name="desc" maxlength="6" class="form-control numeric ctrl" disabled style="display: inline-block; width: 60px; height: 30px; padding: .375rem .3rem;" value="{m_descp}">
                              <span> %</span>
                            </td>
