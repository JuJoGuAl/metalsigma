                ...
                <div class="row">              
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="dato" class="control-label col-form-label">EQUIPO</label>
                      <input type="text" class="form-control validar" id="dato" name="dato" maxlength="100" placeholder="ASIGNE UN NOMBRE PARA EL EQUIPO" value="{equipo}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="marca" class="control-label col-form-label">MARCA</label>
                      <select name="marca" id="marca" class="form-control validar list">
                        <option value="-1">SELECCIONE UNA OPCION</option>
                        <!-- START BLOCK : marca_det -->
                        <option value="{codigo}" {selected}>{marca}</option>
                        <!-- END BLOCK : marca_det -->
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="modelo" class="control-label col-form-label">MODELO</label>
                      <input type="text" class="form-control validar" id="modelo" name="modelo" maxlength="80" placeholder="INDIQUE EL MODELO DEL EQUIPO" value="{modelo}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="segmento" class="control-label col-form-label">SEGMENTO</label>
                      <select name="segmento" id="segmento" class="form-control validar list">
                        <option value="-1">SELECCIONE UNA OPCION</option>
                        <!-- START BLOCK : seg_det -->
