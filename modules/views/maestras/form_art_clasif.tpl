        ...
        <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
            <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                <ol class="breadcrumb mb-0 justify-content-end p-0 bg-white">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">CLASIF. ART</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="row">              
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="dato" class="control-label col-form-label">DESCRIPCION</label>
                      <input type="text" class="form-control validar" id="dato" name="dato" maxlength="100" placeholder="ASIGNE UNA DESCRIPCION A LA CLASIFICACION" value="{clasificacion}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="art" class="control-label col-form-label">¿APLICA A ARTICULOS?</label>
                      <select name="art" id="art" class="form-control validar list">
