                ...
                <div class="row">              
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="dato" class="control-label col-form-label">SEGMENTO</label>
                      <input type="text" class="form-control validar" id="dato" name="dato" maxlength="100" placeholder="ASIGNE UN NOMBRE PARA EL SEGMENTO" value="{segmento}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label for="ins" class="control-label col-form-label">INSUMOS (%)</label>
                      <input type="text" class="form-control validar numeric" id="ins" name="ins" maxlength="5" placeholder="ASIGNE UN MARGEN PARA LOS INSUMOS" value="{mar_ins}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label for="rep" class="control-label col-form-label">REPUESTOS (%)</label>
                      <input type="text" class="form-control validar numeric" id="rep" name="rep" maxlength="5" placeholder="ASIGNE UN MARGEN PARA LOS REPUESTOS" value="{mar_rep}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label for="ter" class="control-label col-form-label">SERV. TERC (%)</label>
                      <input type="text" class="form-control validar numeric" id="ter" name="ter" maxlength="5" placeholder="ASIGNE UN MARGEN PARA LOS SERVICIOS TERCERIZADOS" value="{mar_stt}" {read}>
                    </div>
                  </div>
                </div>
              </div>
