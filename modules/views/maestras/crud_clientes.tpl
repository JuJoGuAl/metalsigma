      ...
      <div class="material-card card">
        <div class="card-body">
          ...
          <div class="button-group">              
              ...
              <!-- END BLOCK : data_new -->
              <button class="btn btn-outline-secondary waves-effect waves-light menu" type="button" data-menu="{mod}" data-mod="{submod}" data-ref="CRUD_GIROS" data-subref="{subref}" data-acc="MODULO" data-id="0"><span class="btn-label"><i class="fas fa-arrow-right"></i></span> GIROS</button>
          </div>
          <br>
