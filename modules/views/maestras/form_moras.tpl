                ...
                <div class="row">              
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="dato" class="control-label col-form-label">PAGO</label>
                      <input type="text" class="form-control validar" id="dato" name="dato" maxlength="100" placeholder="ASIGNE UN NOMBRE PARA LA CONDICION DE PAGO" value="{dato}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="gastos" class="control-label col-form-label">GASTOS FINANCIEROS (%)</label>
                      <input type="text" class="form-control numeric validar" id="gastos" name="gastos" maxlength="5" placeholder="ASIGNE UN % PARA LOS GASTOS FINANCIEROS" value="{gastos}" {read}>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="margen" class="control-label col-form-label">MARGEN DE GANANCIA (%)</label>
                      <input type="text" class="form-control numeric validar" id="margen" name="margen" maxlength="5" placeholder="ASIGNE UN VALOR PARA EL MARGEN DE GANANCIA (%)" value="{margen}" {read}>
                    </div>
                  </div>
                </div>
              </div>
