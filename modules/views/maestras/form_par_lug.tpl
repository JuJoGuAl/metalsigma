        ...
        <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
            <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                <ol class="breadcrumb mb-0 justify-content-end p-0 bg-white">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">SITIOS</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  <label for="valor" class="control-label col-form-label">SITIO DE TRABAJO</label>
                  <input type="text" class="form-control validar" id="valor" name="valor" maxlength="100" placeholder="DESCRIBA EL SITIO DE TRABAJO" value="{lugar}" {read}>
                </div>
              </div>
            </div>
          </div>
