            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="valor" class="control-label col-form-label">NOMBRE DEL EQUIPO</label>
                  <input type="text" class="form-control validar" id="valor" name="valor" maxlength="100" placeholder="DESCRIBA EL EQUIPO DE TRABAJO" value="{equipo}" {read}>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="num" class="control-label col-form-label"># TRABAJADORES</label>
                  <input type="text" class="form-control validar numeric" id="num" name="num" maxlength="1" value="{trabs}" {read}>
                </div>
              </div>
            </div>
          </div>
