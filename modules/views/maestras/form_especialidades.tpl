                ...
                <div class="row">              
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="dato" class="control-label col-form-label">ESPECIALIDAD</label>
                      <input type="text" class="form-control validar" id="dato" name="dato" maxlength="100" placeholder="ASIGNE UN NOMBRE PARA LA ESPECIALIDAD" value="{especialidad}" {read}>
                    </div>
                  </div>
                </div>
              </div>
