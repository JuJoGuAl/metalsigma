                ...
                <div class="row">              
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control validar" id="codigo" name="codigo" maxlength="20" placeholder="INSERTE UN CODIGO PARA EL SERVICIO" value="{codigo2}" {read}>
                    </div>
                  </div>
                  <div class="col-lg-6 col-sm-12">
                    <div class="form-group">
                      <label for="nombre" class="control-label col-form-label">SERVICIO</label>
                      <input type="text" class="form-control validar" id="nombre" name="nombre" maxlength="50" placeholder="NOMBRE O DESCRIPCION CORTA DEL SERVICIO" value="{articulo}" {read}>
                    </div>
                  </div>
                  <div class="col-lg-6 col-sm-12">
                    <div class="form-group">
                      <label for="desc" class="control-label col-form-label">DESCRIPCION</label>
                      <textarea class="form-control" rows="3" id="desc" name="desc" maxlength="500" placeholder="DESCIPCION DEL SERVICIO" {read}>{descripcion}</textarea>
                    </div>
                  </div>                  
                  <div class="col-sm-6">
                    <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control validar numeric" id="precio" name="precio" maxlength="12" placeholder="PRECIO DEL SERVICIO" value="{precio}" {read}>
                    </div>
                  </div>                  
