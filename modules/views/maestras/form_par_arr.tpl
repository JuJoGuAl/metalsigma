        ...
        <form role="form" name="form_" id="form_" enctype="multipart/form-data">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="esp" class="control-label col-form-label"># ESPACIO</label>
                  <input type="text" class="form-control validar numeric" id="esp" name="esp" maxlength="4" value="{espacio}" {read}>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="margen" class="control-label col-form-label">MARGEN UF (%)</label>
                  <input type="text" class="form-control validar numeric" id="margen" name="margen" maxlength="5" value="{mar_uf}" {read}>
                </div>
              </div>
            </div>
          </div>
