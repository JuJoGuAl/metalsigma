...
<page backtop="20mm" backbottom="20mm" backleft="10mm" backright="10mm" style="font-size: 12px;">
    ...
    <ul>
        ...
        <li>EL CLIENTE INTERVINO EL COMPONENTE O SISTEMA REPARADO POR <strong><?php echo constant("BUSSINES NAME"); ?></strong>.</li>
        <li>EL MONTAJE DEL COMPONENTE NO SE REALIZO DE ACUERDO CON EL MANUAL DE PROCEDIMIENTOS DEL FABRICANTE, EN CASO DE QUE EL MONTAJE DEL COMPONENTE NO SEA REALIZADO POR <strong><?php echo constant("BUSSINES NAME"); ?></strong>.</li>
        <li>EL EQUIPO PRESENTA DESPERFECTOS EN UN SISTEMA O COMPONENTE NO INTERVENIDO POR <strong><?php echo constant("BUSSINES NAME"); ?></strong>.</li>
    ...
    <ul>
        <li>EN CASO DE QUE POR RAZONES AJENAS A <strong><?php echo constant("BUSSINES NAME"); ?></strong> EL TRABAJO NO PUEDA SER EJECUTADO EN LA FECHA ACORDADA CON EL CLIENTE, YA SEA POR INDISPONIBILIDAD DEL EQUIPO, INDISPONIBILIDAD DE LOS REPUESTOS EN CASO DE SER SUMINISTRADOS POR EL CLIENTE, ETC., SE REALIZARA UN COBRO ADICIONAL DE 15 UF POR CADA JORNADA DE TRABAJO PERDIDA MAS GASTOS DE TRASLADOS, LO QUE SE SUMARA AL VALOR DEL SERVICIO SEÑALADO EN ESTA COTIZACION.</li>
    </ul>
    ...
    <ul>
        ...
        <li>EN CASO DE QUE EL CLIENTE DEFINA SUMINISTRAR LOS REPUESTOS PARA LA REPARACION, ESTE CONTARA CON 10 DIA HABILES PARA LA ENTREGA DE LA TOTALIDAD DE LOS REPUESTOS REQUERIDOS PARA LA REPARACION A <strong><?php echo constant("BUSSINES NAME"); ?></strong>.</li>
        ...
        <li>EN CASO DE QUE EL EQUIPO O COMPONENTE NO SEA RETIRADO, PREVIA CANCELACION DE LOS GASTOS DE EVALUACION Y ARRIENDO DE NAVE, ANTES DE 60 DIAS CORRIDOS DESPUES DE EMITIDO EL PRESUPUESTO O INFORME DE REPARACION, <strong><?php echo constant("BUSSINES NAME"); ?></strong> TENDRA LOS DERECHOS SOBRE EL EQUIPO PARA SU DISPOSICION FINAL.</li>
    </ul>
